...
//===----------------------------------------------------------------------===//
//
//  This file defines the LinkEquivalenceContext class which checks for
//  structural equivalence between types.
//
//===----------------------------------------------------------------------===//

#ifndef PET_LINK_EQUIVALENCE_H
#define PET_LINK_EQUIVALENCE_H
...
/// external storage.
enum class LinkEquivalenceKind {
  Default,
  Minimal,
};

struct LinkEquivalenceContext {
  ...
  LinkEquivalenceContext(const LangOptions &LangOpts, ASTContext &FromCtx,
                               ASTContext &ToCtx,
                               NonEquivalentDeclSet &NonEquivalentDecls,
                               LinkEquivalenceKind EqKind,
